...
return [
    ...
    //-- Index page --//
    'Welcome' => 'Willkommen ',
    'to our new platform for tournaments!' => ' auf unserer neuen Plattform für Turniere!',
    ...
    'There was an error sending email.' => 'Es ist ein Fehler beim Senden der E-Mail aufgetreten.',

    // password reset
    'If you forgot your password you can' => 'Wenn Sie ihr passwort vergessen haben können Sie',
    'reset it' => 'es zurücksetzen',
    'Request password reset' => 'Anfrage zum Zurücksetzen des Passworts',
    'Please fill out your email.' => 'Bitte geben Sie Ihre E-Mail-Adresse an.',
    'Reset password' => 'Passwort zurücksetzen',
    'A link to reset password will be sent to your email.' => 'Ein Link um ihr Passwort zurückzusetzen wird Ihnen per E-Mail zugesendet.',
    'Check your email for further instructions.' => 'Überprüfen Sie Ihr E-Mail-Postfach für weitere Anweisungen.',
    ...
    'Sorry, we are unable to reset password for email provided.' => 'Wir konnten das Passwort zu der angegebenen E-Mail-Adresse nicht zurücksetzen.',
    'Password reset token cannot be blank.' => 'Passwort-Reset-Token kann nicht leer sein.',
    'Wrong password reset token.' => 'Das angegebene Token ist ungültig.',

    // signup
    'Signup'   => 'Registrieren',
    'Please fill out the following fields to signup:' => 'Bitte füllen Sie die folgenden Felder aus um sich anzumelden:',
    'We will send you an email with account activation link.' => 'Wir werden Ihnen eine E-Mail mit einem Kontoaktivierungslink zusenden.',
    ...
    'We haven\'t created any galleries yet.' => 'Es wurden noch keine Bilder veröffentlicht.',
    'We haven\'t added any videos yet.' => 'Es wurden noch keine Videos veröffentlicht.',
    'We haven\'t added any Hall of fame Members yet.' => 'Es wurden noch keine Hall Of Fame Mitglieder hinzugefügt.',
    'We haven\'t added any events yet.' => 'Es wurden noch keine Events hinzugefügt.',
    'Read more'    => 'Lies mehr',
   ...
   'A single-elimination tournament—also called an Olympic system tournament, a knockout (or, knock-out), single penetration, or sudden death tournament—is a type of elimination tournament where the loser of each bracket is immediately eliminated from winning the championship or first prize in the event.' => 'Das K.-o.-System (von englisch knockout, etwa „herausschlagen“ oder „außer Gefecht setzen“), seltener auch Einzelausscheidung (englisch Single elimination im Unterschied zu Double elimination, siehe Double knock out) oder Pokalsystem (englisch Cup System), ist eine Turnierform, die in Sportarten wie z. B. Tennis angewendet wird, wobei der Verlierer einer Begegnung aus dem Turnier ausscheidet.',
    ...
    'Winners Bracket'     => 'Gewinner Turnierbaum',
    'Match'     => 'Spiel',
    'Winner'     => 'Sieger',
    'Scores'     => 'Punkte',
    'Report'     => 'Einreichen',
    ...
    'Please, click here to activate your account.' => 'Bitte, klicken Sie hier um ihr Konto zu aktivieren.',

    //PLAYER
    'ONLY your channel name: http://twitch.tv/[CHANNELNAME].' => 'NUR dein Kanalname: http://twitch.tv/[CHANNELNAME].',
    'E.g. english, german, french.' => 'Z.B. Englisch, Deutsch, Französisch.',
    'Only your age will be displayed.' => 'Nur dein Alter wird angezeigt.',
    'Format: YYYY-MM-DD' => 'Format: JJJJ-MM-TT',
    'http://example.de/example' => 'http://beispiel.de/beispiel',
    'Owner' => 'Besitzer',
    'Running Nr' => 'Laufende Nr',
    'Games' => 'Spiele',
    'Website' => 'Webseite',
    'Twitch Channel Name' => 'Twitchkanal-Name',
    'Gender' => 'Geschlecht',
    'Languages' => 'Sprachen',
    'Age' => 'Alter',
    ...
    'Personal information' => 'Persönliche Informationen',
        'This individual is still not a member of a team yet.' => 'Dieser Spieler ist noch keinem Team beigetreten. ',
        'Tournament' => 'Turnier',
        'Date' => 'Datum',
        'Rank' => 'Rang',
        'Game History' => 'Spiel Historie',
