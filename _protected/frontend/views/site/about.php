...
<div class="site-about" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="row">
            ...
            <div class="well bs-component no-padding">
                ...
                <div class="with-padding">
                    ...
                    <p>
                        ...
                        <strong>Alter:</strong> <?= age('03/08/1990') ?> </br>
                        <strong>Beruf:</strong> Informatiker</br>
                        <strong>Rolle:</strong> Orga, PR, Soziale Medien, Streaming</br>
                        <strong>Mail:</strong> <a class="contact-mail"
                                                  href="mailto:jodder@barcraft-hl.de">jodder@barcraft-hl.de</a> </br>
                    </p>
                    <p>Als Kanzler und ich 2013 auf battle.net einen Aufruf entdeckten BarCrafts zu veranstalten, stand
                        für
                        mich
                        sofort fest, dass dies mein Baby werden sollte. </p>
                    <p>Ich kümmere mich um die Veranstaltungsorganisation und -koordination und Leite die Turniere. Auch
                        die
                        Planung
        ...
        <div class="col-lg-4 col-md-6">
            <div class="well bs-component no-padding">
                <img src="<?= Url::to("@web/images/constant/team/Kanzler.jpg") ?>" class="md-card-img" alt="Kanzler">
                <div class="with-padding">
                    <h3>Kanzler</h3>
                    <p>
                    ...
                    <p>Ich kümmere mich um die Webseite und alle Designaufgaben wie Plakate, Logos, Aushänge, etc. Bei
                        den
                        Turnieren helfe bei der Organisation und kümmere mich um die Technik und unseren Livestream. Ich
                        bin
                        selbst leidenschaftlicher E-Sport-Fan und habe damals erfolgreich CS Source gespielt. Derzeit
                        spiele
        ...
        <div class="col-lg-4 col-md-6">
            <div class="well bs-component no-padding">
                <img src="<?= Url::to("@web/images/constant/team/Zersch.jpg") ?>" class="md-card-img" alt="Zersch">
                <div class="with-padding">
                    <h3>Zersch</h3>
                    <p>
                    ...
                    <p>Ich habe schon in jungen Jahren angefangen zu zocken. Meine ersten Erfahrungen machte ich mit
                        Counterstrike, Warcraft und Diablo. Damals besuchte ich sehr gerne Lan-Partys, leider finden
                        diese
                        so nur noch selten statt. Ich war und bin kein Profi, aber das war auch nie mein Ziel. Für mich
                        war
                        es immer wichtiger Spaß zu haben. Die Turniere lassen alte Zeiten wiederaufleben. BarCraft- oder
                        BarStone-Events zu veranstalten macht mir Freude, vor allem wenn ich sehe, dass ihr daran
                        genauso
        ...
        <div class="col-lg-4 col-md-6">
            <div class="well bs-component no-padding">
                <img src="<?= Url::to("@web/images/constant/team/NiWo.jpg") ?>" class="md-card-img" alt="NiWo">
                <div class="with-padding">
                    <h3>NiWo</h3>
                    <p>
                    ...
                    <p>Von 2008 bis 2011 spielte ich als Pro bei <em>Meet Your Makers</em> im Dota 1 Squad. In dieser
                        Zeit
                        waren wir auch sehr erfolgreich, leider fehlte mir im Verlauf die Zeit um weiter zu machen. Als
                        Dota
                        2 erschien, trat ich der <em>Dota Athletes Liga</em> als Caster bei. Hier arbeite ich bis Heute
                        als
                        Caster und Streamer im MOBA Berreich (DOTA 2). </p>
                    <p>Ich bin ein sehr begeisteter Gamer und als die Möglichkeit aufkam hier in Lübeck ebenfalls in
                        diesem
        ...
        <div class="col-lg-4 col-md-6">
            <div class="well bs-component no-padding">
                <img src="<?= Url::to("@web/images/constant/team/TyphoonHawk.jpg") ?>" class="md-card-img" alt="TyphoonHawk">
                <div class="with-padding">
                    <h3>TyphoonHawk</h3>
                    <p>
                        ...
                        <strong>Beruf:</strong> Informatiker</br>
                        <strong>Rolle:</strong> Caster, Aufbau Location, Technik</br>
                        <strong>Mail:</strong> <a class="contact-mail"
                                                  href="mailto:typhoonhawk@barcraft-hl.de">typhoonhawk@barcraft-hl.de</a> </br>
                    </p>
                    <p>E-Sports Turniere zu verfolgen macht mir viel Spaß. Daher freut es mich durch Barcraft dieses
                        Hobby
        ...
        <div class="col-lg-4 col-md-6">
            <div class="well bs-component no-padding">
                <img src="<?= Url::to("@web/images/constant/team/Haruc.jpg") ?>" class="md-card-img" alt="Haruc">
                <div class="with-padding">
                    <h3>Haruc</h3>
                    <p>
                    ...
                    <p>Es ist für mich nicht nur eine Chance in seinem strukturellen, strategischen und kreativen Denken
                        über sich hinaus zu wachsen, sondern ebenso das Spiel, den Wettbewerb und das Teamgefühl mit
                        anderen
                        Spielern gebannt zu verfolgen und zu genießen.</p>
                    <p>Begonnen habe ich damals mit Warcraft III sowie CS 1.6 und spiele nun aktiv Starcraft II, Heroes
                        of
                        the Storm und Hearthstone. Aktuell kümmere ich mich bei den Barcrafts mit um den Aufbau und um
                        Nebenorganisatorisches während der Events. Dabei versuche ich stets aus der Distanz (Hamburg)
                        eine
        ...
        <div class="col-lg-4 col-md-6">
            <div class="well bs-component no-padding">
                <img src="<?= Url::to("@web/images/constant/team/BehEh.jpg") ?>" class="md-card-img" alt="BehEh">
                <div class="with-padding">
                    <h3>BehEh</h3>
                    <p>
                        <strong>Vorname:</strong>Benedict<br>
                        <strong>Alter:</strong> 22 <br>
                        <strong>Beruf:</strong> Informatiker<br>
                        <strong>Rolle:</strong> Casting, Aufbau Lokation, bald Replays?<br>
                        <strong>Mail:</strong> <a href="mailto:beheh@barcraft-hl.de">beheh@barcraft-hl.de</a> <br>
                    </p>
                    <p>Moin, ich bin BehEh! Ich bin seit der Anbeginn der Beta an Hearthstone interessiert und verfolge
                        fast täglich die Streams der bekannten Spieler.</p>
                    <p>Selbst spiele ich nicht ganz so viel, entwickle aber Tools die mich und andere Spieler bei
                        Hearthstone unterstützen. In letzter Zeit caste ich auch sehr gerne und lerne einiges dazu. Die
                        BarCraftHL-Events sind seit meiner ersten Teilnahme nur besser geworden, und ich freue mich nun
                        auch Teil des Teams zu sein.</p>
                </div>
            </div>
        </div>
    </div>
