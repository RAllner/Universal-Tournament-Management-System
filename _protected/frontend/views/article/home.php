...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="well center">
            <p class="lead center">
                Powered by:
                Universal Tournament Management System (UTMS)
            <div class="alpha centered">
                Alpha 0.3.4 <?= Html::a(Yii::t('app', 'Report Bugs'), ["@web/../site/contact"]) ?>
            </div>
            ...
            <?php } else {
                ...
                <div class="row"style="vertical-align: middle">
                    <div class="col-xs-6" style="text-align: right">
                        2. Registriere dich bei einem Turnier!
                    </div>
                    <div class="col-xs-6" style="text-align: left">
                        <a class="btn btn-warning"
                           href="<?= Url::to('@web/tournament/index') ?>"><?php echo Yii::t('app', 'Tournaments'); ?></a>
                    </div>
                </div>
                <?php
            } ?>
